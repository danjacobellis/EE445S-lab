...
1. In lab.c create an array containing the binary 'tree.png' image. Please see the instructions on [managing data between MATLAB and C][1]. (you can copy and paste the variable declaration from this page.)
